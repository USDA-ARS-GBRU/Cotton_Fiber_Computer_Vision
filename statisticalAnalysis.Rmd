...
fullmod.fit <- brm(nHemisphere | trials(nFibers) ~ Genotype + Method + Method:Genotype + (1 | ImageName), 
...
```{r, 12 img model}
fullmod.12.fit <- brm(nHemisphere | trials(nFibers) ~ Genotype + Method + Method:Genotype + (1 | ImageName), 
